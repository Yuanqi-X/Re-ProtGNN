...
\label{sec:svp}
A separate 20\% test split from the MUTAG dataset~\citep{debnath1991structure} will be used to assess the model’s classification effectiveness and the clarity of its prototype-based explanations, with accuracy serving as the main benchmark.
...
Input: The MUTAG dataset files~\citep{debnath1991structure}.

...
# ========== GIN Model with Prototype Learning ==========
class GINNet(nn.Module):
    def __init__(self, input_dim, output_dim, model_args):
        ...
        # Final linear layer: prototype activations → logits
    ...
    # Compute distance & similarity between graph embedding and all prototypes
    ...
    def forward(self, data, protgnn_plus=False, similarity=None):
        ...
        node_emb = x  # Node-level embeddings for potential explanation use
